...
from backend.app.api.v1.endpoints.integrations.econet import router as econet_integration_router
from backend.app.api.v1.endpoints.integrations.sittax import router as sittax_integration_router
...
api_router.include_router(econet_integration_router)
api_router.include_router(sittax_integration_router)
